...
mod tests {
	...
	fn operating_mode_key_computed_properly() {
		...
		assert_eq!(
			...
			array_bytes::hex2bytes_unchecked(
				"dd16c784ebd3390a9bc0357c7511ed010f4cf0917788d791142ff6c1f216e7b3"
			),
	...
	fn storage_message_key_computed_properly() {
		...
		assert_eq!(
			storage_key,
			array_bytes::hex2bytes_unchecked("dd16c784ebd3390a9bc0357c7511ed018a395e6242c6813b196ca31ed0547ea79446af0e09063bd4a7874aef8a997cec746573742a00000000000000"),
			"Unexpected storage key: {}",
			array_bytes::bytes2hex("", &storage_key),
		);
	}
	...
	fn outbound_lane_data_key_computed_properly() {
		...
		assert_eq!(
			storage_key,
			array_bytes::hex2bytes_unchecked("dd16c784ebd3390a9bc0357c7511ed0196c246acb9b55077390e3ca723a0ca1f44a8995dd50b6657a037a7839304535b74657374"),
			"Unexpected storage key: {}",
			array_bytes::bytes2hex("", &storage_key),
		);
	}
	...
	fn inbound_lane_data_key_computed_properly() {
		...
		assert_eq!(
			storage_key,
			array_bytes::hex2bytes_unchecked("dd16c784ebd3390a9bc0357c7511ed01e5f83cf83f2127eb47afdc35d6e43fab44a8995dd50b6657a037a7839304535b74657374"),
			"Unexpected storage key: {}",
			array_bytes::bytes2hex("", &storage_key),
		);
	}
