...
impl Chain for CrabChain {
	...
	const BEST_FINALIZED_HEADER_ID_METHOD: &'static str =
		bp_crab::BEST_FINALIZED_CRAB_HEADER_METHOD;
...
impl ChainWithMessages for CrabChain {
	const WITH_CHAIN_MESSAGES_PALLET_NAME: &'static str = bp_crab::WITH_CRAB_MESSAGES_PALLET_NAME;
	const TO_CHAIN_MESSAGE_DETAILS_METHOD: &'static str = bp_crab::TO_CRAB_MESSAGE_DETAILS_METHOD;
	const TO_CHAIN_LATEST_GENERATED_NONCE_METHOD: &'static str =
		bp_crab::TO_CRAB_LATEST_GENERATED_NONCE_METHOD;
	const TO_CHAIN_LATEST_RECEIVED_NONCE_METHOD: &'static str =
		bp_crab::TO_CRAB_LATEST_RECEIVED_NONCE_METHOD;
	const FROM_CHAIN_LATEST_RECEIVED_NONCE_METHOD: &'static str =
		bp_crab::FROM_CRAB_LATEST_RECEIVED_NONCE_METHOD;
	const FROM_CHAIN_LATEST_CONFIRMED_NONCE_METHOD: &'static str =
		bp_crab::FROM_CRAB_LATEST_CONFIRMED_NONCE_METHOD;
	const FROM_CHAIN_UNREWARDED_RELAYERS_STATE: &'static str =
		bp_crab::FROM_CRAB_UNREWARDED_RELAYERS_STATE;
