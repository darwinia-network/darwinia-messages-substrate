...
impl Chain for DarwiniaChain {
	...
	const BEST_FINALIZED_HEADER_ID_METHOD: &'static str =
		bp_darwinia::BEST_FINALIZED_PANGORO_HEADER_METHOD;
...
impl ChainWithMessages for DarwiniaChain {
	const WITH_CHAIN_MESSAGES_PALLET_NAME: &'static str =
		bp_darwinia::WITH_PANGORO_MESSAGES_PALLET_NAME;
	const TO_CHAIN_MESSAGE_DETAILS_METHOD: &'static str =
		bp_darwinia::TO_PANGORO_MESSAGE_DETAILS_METHOD;
	const TO_CHAIN_LATEST_GENERATED_NONCE_METHOD: &'static str =
		bp_darwinia::TO_PANGORO_LATEST_GENERATED_NONCE_METHOD;
	const TO_CHAIN_LATEST_RECEIVED_NONCE_METHOD: &'static str =
		bp_darwinia::TO_PANGORO_LATEST_RECEIVED_NONCE_METHOD;
	const FROM_CHAIN_LATEST_RECEIVED_NONCE_METHOD: &'static str =
		bp_darwinia::FROM_PANGORO_LATEST_RECEIVED_NONCE_METHOD;
	const FROM_CHAIN_LATEST_CONFIRMED_NONCE_METHOD: &'static str =
		bp_darwinia::FROM_PANGORO_LATEST_CONFIRMED_NONCE_METHOD;
	const FROM_CHAIN_UNREWARDED_RELAYERS_STATE: &'static str =
		bp_darwinia::FROM_PANGORO_UNREWARDED_RELAYERS_STATE;
